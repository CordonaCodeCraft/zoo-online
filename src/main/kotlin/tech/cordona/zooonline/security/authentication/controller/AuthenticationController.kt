...
class AuthenticationController(
	...
	fun register(@Valid @RequestBody newUser: UserModel) = authenticationService.register(newUser)

	@PostMapping(VERIFY_EMAIL_URL)
	fun verifyEmail(@Valid @RequestParam token: String) = authenticationService.verifyEmail(token)
